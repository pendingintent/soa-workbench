...
![alt text](../src/soa_builder/web/static/images/select_concept_groups.png)

2. Select `New Group`.

![alt text](../src/soa_builder/web/static/images/create_new_group_1.png)

If there are existing groups, the user can choose to copy the group and `tagged` biomedical concepts.

![alt text](../src/soa_builder/web/static/images/create_new_group_2.png)

3. Once the group has been created, the user can `tag` (assign) biomedical concepts to add to the group.

![alt text](../src/soa_builder/web/static/images/add_bc_to_group_1.png)

![alt text](../src/soa_builder/web/static/images/add_bc_to_group_2.png)
...
![alt text](../src/soa_builder/web/static/images/select_activties.png)

5. The user can then select a group from the select dropdown for any activity.

![alt text](../src/soa_builder/web/static/images/select_group_for_activity.png)

## Customize Biomedical Concepts in a group

1. On the `Biomedical Concepts` > `Concept Groups` page, expand a group.

![alt text](../src/soa_builder/web/static/images/customize_group.png)
...
![alt text](../src/soa_builder/web/static/images/customize_activity_group.png)
...
![alt text](../src/soa_builder/web/static/images/remove_activity_group.png)
