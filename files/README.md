...
<table>
    ...
    <tr>
        <td>CDISC_Pilot_Study_v4.json</td>
    ...
    <tr>
        <td>NCT01797120_Footnote_2.html</td>
        <td>HTML Table loaded in the SOA Workbench to support footnotes for NCT01797120.  This file was created outside of the Workbench and the markup copy and pasted when creating the footnote.</td>
    </tr>
    <tr>
        <td>SDTMIGv3.4.pdf</td>
        <td>SDTM v3.4 Implementation Guide</td>
    </tr>
    <tr>
        <td>USDM_API_v4.0.0.json</td>
        <td>USDM v4.0 Schema</td>
    </tr>
    <tr>
        <td>USDM-IG_v4.pdf</td>
